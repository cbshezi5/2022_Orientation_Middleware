...
//             }
        ...
        $this->Cell(0,180,"This document was generated by the Tshwane University of Technology for admin ".$noOfElements ,2,0,'C');
	   
	$json_obj = '{"message": "Pdf returned","error": "nonor"}';
